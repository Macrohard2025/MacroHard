...
addEventListener("DOMContentLoaded", () => {
    //Repensar esta logica. Probar enviar una unica solicitud al servidor para que traiga todas las jugadas de la partida
    //Almacenar en  localstorage las jugadas, existentes y nuevas
    //Cuando el jugador finaliza su turno, se manda al servidor la jugada pero solo a modo de registro en la bd
    //En el localstorage se almacena la jugada realizada
