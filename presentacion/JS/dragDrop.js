document.addEventListener("DOMContentLoaded", () => {
    ...
    const traduccionesRecintos = {
        ...
        "El-puesto-de-observacion": idioma === "en" ? "Observation Post" : "Puesto de Observación",
        "La-piramide": idioma === "en" ? "The Pyramid" : "La Pirámide",
        ...
        "El-trio-frondoso": idioma === "en" ? "Leafy Trio" : "Trío Frondoso",
